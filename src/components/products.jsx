      ...
      <div className=" grid  place-items-center pt-14 bg-neutral-100">
        <div className="flex flex-col justify-center mx-6">
          <div>
            ...
            <p className="pb-9 pt-2 text-sm opacity-50">Get the best deals before they are gone!</p>
          </div>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="flex justify-between align-bottom items-center px-4 pt-2 pb-6">
                  ...
                  <div>
                    <button className="pl-4 pr-5 py-3 bg-yellow-400 hover:bg-yellow-500 rounded-full text-sm font-medium cursor-pointer">
